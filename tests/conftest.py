...
TEST_DATABASE_URL = os.getenv(
    "TEST_DATABASE_URL",
    "postgresql+psycopg://llh@localhost:5432/scaffold_fastapi_test",
)
...
os.environ["APP_NAME"] = "FastAPI Application"
...
def test_user(db_session: Session) -> User:
    user = User(
        ...
        avatar_seed=security.make_avatar_seed("demo"),
        avatar_bg_color=security.make_avatar_color("demo"),
    )
    db_session.add(user)
    db_session.commit()
